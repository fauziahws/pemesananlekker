                ...
                <div class="space-y-6">
                    ...
                    @if($product->image)
                        <div class="flex items-center p-4 bg-red-50 rounded-xl border border-red-200">
                            ...
                            <label for="delete_image" class="ml-3">
                                <span class="text-sm font-semibold text-red-900">Delete current image</span>
                                <p class="text-xs text-red-700">Check this to remove the product image</p>
                            </label>
                        </div>
                    @endif

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <a href="{{ route('cashier.orders.all') }}" class="text-blue-600 hover:text-blue-700">
                        Lihat Semua Pesanan →
                    </a>
                </div>

                @if($orders->isEmpty())
                    <p class="text-gray-500 text-center py-8">Tidak ada pesanan pending.</p>
                @else
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($order->paid)
                                                <span class="ml-1 text-xs text-green-600">✓ Dibayar</span>
                                            @endif
                                        </td>

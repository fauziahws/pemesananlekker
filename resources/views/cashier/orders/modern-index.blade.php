<x-modern-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Active orders waiting to be processed</p>
        </div>

        <!-- Navigation Tab -->
        <div class="flex space-x-2 mb-6">
            <a href="{{ route('cashier.orders') }}" class="px-6 py-3 bg-gradient-to-r from-[#7B542F] to-[#A0724B] text-white rounded-xl font-medium shadow-md">
                Pending Orders
            </a>
            <a href="{{ route('cashier.orders.all') }}" class="px-6 py-3 bg-white text-gray-700 rounded-xl font-medium hover:bg-gray-50 border border-gray-200 transition">
                All Orders
            </a>
        </div>
        ...
        @if($orders->isEmpty())
            ...
            <div class="bg-white rounded-2xl shadow-md p-12 text-center border border-gray-100">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">No Pending Orders</h3>
